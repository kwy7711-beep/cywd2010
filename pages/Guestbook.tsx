...
export const Guestbook: React.FC = () => {
  ...
  return (
    <div className="h-full flex flex-col overflow-y-auto">
      ...
      {/* Input Area */}
      <div className="bg-gray-100 p-3 mb-6 border border-gray-300 flex gap-3">
        <div className="w-24 bg-white border border-gray-200 h-24 flex items-center justify-center text-gray-300 text-xs overflow-hidden">
        ...
        <div className="flex-1 flex flex-col">
          <textarea
            ...
            className="flex-1 resize-none border border-gray-300 p-2 text-xs focus:outline-none focus:border-cyworld-blue mb-1"
            placeholder="일촌평을 남겨주세요~!"
          />
          <div className="flex justify-end">
             <button 
               onClick={handleAddEntry}
               className="bg-white border border-gray-300 px-4 py-1 text-xs text-gray-600 hover:text-cyworld-orange hover:border-cyworld-orange"
             >
               확인
             </button>
          </div>
        ...
        {entries.map((entry) => (
          <div key={entry.id} className="bg-gray-50 p-3 border-t border-b border-gray-200">
             ...
             <div className="flex gap-4 pl-2">
                {/* Changed to w-12 h-12 (Square 1:1) */}
                <img src={entry.avatarUrl} alt="avatar" className="w-12 h-12 border border-gray-300 p-0.5 bg-white object-cover" />
